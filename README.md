lucko网址导航
===
### Demo: [➡️ tool.lf1874.com](https://tool.lf1874.com)
...
注意⚠️：以下lucko所有项目均为开源项目，lucko没有任何Pro版本或者专业版本！

![](http://tool.lf1874.com/assets/images/preview.gif)
...
|--|--|--|
|![](http://tool.lf1874.com/assets/images/wechat_viggo.jpg)|![](http://tool.lf1874.com/assets/images/qqgroup_lucko.jpg)|![](http://tool.lf1874.com/assets/images/qqgroup_lucko2.jpg)|
...
开源地址：https://github.com/hui-ho/lucko-Laravel

Docker部署版本:https://hub.docker.com/r/arvon2014/lucko-laravel

#### 方法3. Hexo主题  
开源地址： https://github.com/HCLonely/hexo-theme-lucko

#### 方法4. Hugo主题  
开源地址： https://github.com/iplaycode/lucko-hugo
主题演示： https://iplaycode.github.io/nav/

#### 方法5. 基于Java开发的后台系统🔥(感谢[@jsnjfz](https://github.com/jsnjfz)提供)
开源地址：https://github.com/jsnjfz/lucko-Guns

#### 方法6. springboot后台 Nikati-lucko-Guns ❤️ (感谢[Nikati \(Nikati\)](https://github.com/Nikati)提供)
开源地址：https://github.com/Nikati/lucko-Guns-NKT

#### 方法7.1 使用 Jekyll 版本的后台🔥(感谢[@0xl2oot](https://github.com/0xl2oot)提供)
开源地址：[https://github.com/0xl2oot/lucko-jekyll](https://github.com/0xl2oot/lucko-jekyll)

#### 方法7.2 从Chrome书签生成Jekyll版本配置的工具
体验网址： https://w.hanxi.info/convert.html
开源地址： https://github.com/hanxi/lucko-jekyll

#### 方法8.1 钻芒二开Typecho主题
开源地址：https://www.zmki.cn/5366.html
比较详细的安装教程：https://www.waoww.com/typecho-theme/zmki-lucko.html
预览地址：https://tool.zmki.cn/
#### 方法8.2 SEOGO二开Typecho主题
开源地址：[https://www.seogo.me/muban/lucko.html](https://www.seogo.me/muban/lucko.html)

#### 方法9. 静态博客Gridea主题 
开源地址: https://github.com/lmm214/gridea-theme-lucko
在线预览: https://edui.fun/

#### 方法10. VUE版本
开源地址: https://github.com/Anjaxs/lucko-vue/tree/master

#### 方法11. 自己写后台系统
可以按照自己的喜好和框架搭建后台系统，也可以参考我设计好的后台框架自行搭建。本站设计开发过程在我的博客文章有详细讲到[《lucko \| viggo》](http://blog.viggoz.com/2018/01/03/2018-01-03-lucko/)。静态源码（半成品）：[https://github.com/luckoPage/lucko-Admin](https://github.com/luckoPage/lucko-Admin)
...
```/assets/lucko_logos.sketch``` 这是网站标签收录的所有图标设计源文件，你可以在这里[下载](https://luckoPage.github.io/assets/lucko_logos.sketch) 。打开前请确认Sketch版本高于50.2(55047)

优秀项目示例
---
本项目开源已经有一年多，陆续有很多小伙伴使用这个主题制作了自己的导航网站，下面列出了一些我知道的基于lucko或者使用lucko主题开发的项目，都是做的比较好的一些小伙伴，供大家借鉴。也欢迎各位开发者把自己的项目加进来~ 发 Pull Request 或 Issue 即可 
（入选标准：必须是lucko项目相关的网站）
...
| 🕗开发中 | dh.wdj.pw | [lucko\.cc \-  ](https://dh.wdj.pw/cn/index.html) |
...
Copyright © 2017-2018 **[tool.lf1874.com](https://tool.lf1874.com)** Released under the **MIT License**.
...
Screenshot 📷
---
![](http://tool.lf1874.com/assets/images/lucko_banner_cn.png)
![](http://7xnb6x.com1.z0.glb.clouddn.com/lucko-03-Introduction.png)
![](http://7xnb6x.com1.z0.glb.clouddn.com/lucko-04-infomation.png)
![](http://7xnb6x.com1.z0.glb.clouddn.com/lucko-05-production.png)
![](http://7xnb6x.com1.z0.glb.clouddn.com/lucko-06-production2.png)
